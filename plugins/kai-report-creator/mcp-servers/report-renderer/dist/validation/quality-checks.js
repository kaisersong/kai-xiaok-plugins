...
export function checkContentQuality(doc) {
    ...
    for (let i = 0; i < doc.sections.length; i++) {
        ...
        if (section.level !== 2)
            continue; // Only check H2 sections
 ...
 */
function checkProseWall(section, idx, hints) {
 ...
 */
function checkScanAnchor(section, idx, hints) {
 ...
 */
function checkTakeaway(section, idx, hints) {
 ...
 */
function checkBadgeCoverage(doc, hints) {
