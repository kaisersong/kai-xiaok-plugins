 ...
 */
export function validateBlocks(blocks, reportClass) {
    const errors = [];
 ...
 */
export function validateBlock(block, reportClass) {
    switch (block.tag) {
        case 'kpi':
 ...
 */
function validateKpi(body, reportClass) {
 ...
 */
function validateChart(chartType, body, reportClass) {
    const trimmed = body.trim();
    if (!trimmed) {
 ...
 */
function validateDiagram(diagramType, body) {
    const trimmed = body.trim();
    if (!trimmed) {
 ...
 */
function validateCallout(body, params) {
    if (!body.trim()) {
 ...
 * Validate code block.
 */
function validateCode(body, params) {
    if (!body.trim()) {
 ...
 */
function validateImage(body, params) {
 ...
 * Validate list block.
 */
function validateList(body, params) {
    if (!body.trim()) {
