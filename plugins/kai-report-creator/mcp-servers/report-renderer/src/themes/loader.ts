...
export function loadTheme(themeName: string): ThemeCSS {
  ...
  const result: ThemeCSS = { name, themeCSS, sharedCSS };
 ...
 */
export function assembleCSS(theme: ThemeCSS, overrides?: Record<string, string>): string {
